...
//The function for the log out button, that takes the user to the first page (Deals)

function hej(){
    var div1 = document.getElementById("accountbox");
    var div2 = document.getElementById("page_content");
